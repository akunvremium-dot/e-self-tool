...
export default function ProfileForm() {
  ...
  return (
    <div className="w-full max-w-sm mx-auto glass-card p-6 animate-in fade-in zoom-in-95 duration-300">
      <h3 className="text-sm font-bold text-cyan-400 mb-4 text-left">Lengkapi Identitas</h3>
      <form onSubmit={handleSubmit} className="space-y-4 text-left">
        <div>
          <label className="block text-xs text-white/50 mb-1.5 ml-1">Nama Lengkap</label>
          <input
            type="text"
            required
            value={name}
        ...
        <div>
          <label className="block text-xs text-white/50 mb-1.5 ml-1">Kota Domisili</label>
          <input
            type="text"
            required
            value={city}
        ...
        <div>
          <label className="block text-xs text-white/50 mb-1.5 ml-1">Nomor WhatsApp</label>
          <input
            type="tel"
            required
            value={whatsapp}
