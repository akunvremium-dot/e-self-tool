// lib/zones.ts
// LOCKED SPEC DO NOT MODIFY ZONE TABLE
...
export const ZONE_TABLE: ZoneData[] = [
  {
    zone: "Void",
    state: "Blank",
    mode: "Break",
